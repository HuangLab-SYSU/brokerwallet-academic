...
public class MedalQueryUtil {
    ...
    /**
     * Query user medal data / 查询用户勋章数据
     */
    public static void queryUserMedals(String address, String privateKey, MedalQueryCallback callback) {
        try {
            ...
            // Send blockchain query using medal contract address
    ...
    /**
     * Query global medal statistics / 查询全局勋章统计
     */
    ...
    /**
     * Send medal contract inquiry request / 发送勋章合约查询请求
     * Use the correct medal contract address: 0x1a202bfa10ea97a742ad22fcb1a7913821bf1b18 / 使用正确的勋章合约地址：0x1a202bfa10ea97a742ad22fcb1a7913821bf1b18
     */
        ...
        try {
            ...
            service.execute(() -> {
                try {
                    ...
                    req.setTo(medalContractAddr);  // Use medal contract address
                    req.setValue("0x0");
                    req.setSign1(sign[0]);
                    req.setSign2(sign[1]);
